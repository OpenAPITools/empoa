...
----
include::../empoa-extended-tck/src/main/java/org/openapitools/empoa/extended/tck/specs/PingSpec.java[]
----
...
The output of this build is an HTML page located at `<git repo root>/build/docs/html5/index.html`.
